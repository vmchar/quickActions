...
{
    //Process shortcut item
    [QuickActionsManager.instance onShortcutItem:shortcutItem];
}
...
- (void)applicationDidEnterBackground:(UIApplication*)application
{
    ...
    [QuickActionsManager.instance onDidEnterBackground];
}
